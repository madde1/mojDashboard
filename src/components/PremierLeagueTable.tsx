...
export default function PremierLeagueTableWidget() {
  ...
  return (
    <div className="rounded-3xl bg-white p-6 text-[#7c9a92] shadow-2xl">
      ...
      {/* TABLE HEADER */}
      <div className="mb-2 grid grid-cols-[30px_1fr_30px_30px_30px_30px] lg:grid-cols-[40px_1fr_40px_40px_40px_50px] items-center border-b border-zinc-800 pb-2 text-xs uppercase tracking-wide text-zinc-500">
        <div>#</div>
        ...
        {table.map((team, index) => {
          ...
          return (
            ...
            key={`${team.strTeam}-${index}`}
              className={`grid grid grid-cols-[30px_1fr_30px_30px_30px_30px] lg:grid-cols-[40px_1fr_40px_40px_40px_50px] items-center rounded-2xl px-3 py-3 transition-all ${
                isArsenal
